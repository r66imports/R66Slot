...
export const ALL_PERMISSIONS: { group: string; name: string; href: string }[] = [
  ...
  { group: 'Content', name: 'Catalogue', href: '/admin/catalogue' },
  ...
  { group: 'Order Network', name: 'Supplier Pre Orders', href: '/admin/supplier-preorders' },
  ...
  { group: 'Order Network', name: 'Pre-Orders Header', href: '/admin/preorder-header' },
  ...
  { group: 'Business & Store', name: 'Poster Generator', href: '/admin/slotcar-orders' },
  { group: 'Business & Store', name: 'Media Library', href: '/admin/media' },
  { group: 'Business & Store', name: 'Photo Editor', href: '/admin/photo-editor' },
