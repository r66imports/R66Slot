...
const COMPONENT_LIBRARY = [
  ...
  { type: 'latest-arrivals' as const, label: 'Latest Arrivals', icon: '🆕', desc: 'New arrivals slider' },
  { type: 'landing-soon' as const, label: 'Landing Soon', icon: '🛬', desc: 'Incoming stock slider' },
  { type: 'specials' as const, label: 'Specials', icon: '🏷️', desc: 'Specials slider' },
  ...
  { type: 'footer' as const, label: 'Footer', icon: '🔻', desc: 'Editable footer with links & columns' },
  ...
  return (
    <div className="fixed inset-0 bg-gray-100 flex flex-col font-play">
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <div className={`${rightCollapsed ? 'w-0' : ''} flex-shrink-0 overflow-hidden transition-all duration-200 flex flex-col min-h-0`}>
          {showPageSettings ? (
