...
export const FULL_PAGE_TEMPLATES: FullPageTemplate[] = [
  {
    id: 'brand-page',
    name: 'Brand Page',
    description: 'Brand showcase with hero, product cards, and footer — based on NSR',
    icon: '🏁',
    sections: ['Header', 'Hero', 'Product Cards', 'Footer'],
    components: [
      {
        id: 'bp-header',
        type: 'header',
        ...
        children: [
          {
            id: 'bp-card-1',
            type: 'icon-text',
            content: '<h3 style="font-size:24px;font-weight:700;color:#fff;margin:0 0 8px;">NSR Slot Cars</h3><p style="font-size:14px;color:rgba(255,255,255,0.8);margin:0 0 16px;text-align:center;">Explore our complete range of NSR racing models</p><a href="/products/cars/nsr" style="display:inline-block;padding:12px 32px;background:#DC2626;color:#fff;border-radius:8px;font-size:15px;font-weight:600;text-decoration:none;">View Cars &rarr;</a>',
            styles: {
          ...
          },
          {
            id: 'bp-card-2',
            type: 'icon-text',
            content: '<h3 style="font-size:24px;font-weight:700;color:#fff;margin:0 0 8px;">NSR Parts</h3><p style="font-size:14px;color:rgba(255,255,255,0.8);margin:0 0 16px;text-align:center;">Quality replacement parts and upgrades</p><a href="/products/parts/nsr" style="display:inline-block;padding:12px 32px;background:#1F2937;color:#fff;border-radius:8px;font-size:15px;font-weight:600;text-decoration:none;">View Parts &rarr;</a>',
            styles: {
