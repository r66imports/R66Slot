...
export default function EditProductPage({
  ...
  const [allPillsHidden, setAllPillsHidden] = useState(false)
  ...
  function toggleAllPills() {
    const next = !allPillsHidden
    setAllPillsHidden(next)
    setCarBrandPillsHidden(next)
    setCarClassPillsHidden(next)
    setRevoPartsPillsHidden(next)
    setSidewaysBrandPillsHidden(next)
    setSidewaysPartsPillsHidden(next)
    setCarTypePillsHidden(next)
    setPagePillsHidden(next)
  }
  // Revo Parts Filter
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button type="button" onClick={toggleAllPills} className="flex items-center gap-1.5 text-xs text-gray-400 hover:text-gray-600" title={allPillsHidden ? 'Show all selections' : 'Hide all selections'}>
                  {allPillsHidden
                  ...
                  {allPillsHidden ? 'Show all' : 'Hide all'}
                </button>
              </div>
              <div className="space-y-4">
