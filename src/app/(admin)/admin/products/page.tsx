...
const IMPORT_PROFILES: Record<string, ImportProfile> = {
  ...
  nsr: {
    ...
    exportRow: (p) => [
      ...
      Array.isArray(p.salesAccount) ? p.salesAccount.join('; ') : (p.salesAccount || ''),
      Array.isArray(p.purchaseAccount) ? p.purchaseAccount.join('; ') : (p.purchaseAccount || ''),
      p.compareAtPrice ?? '', p.costPerItem ?? '', p.preOrderPrice ?? '',
    ],
  },
  revo: {
    label: 'Revo',
    ...
    mapRow: (obj) => ({
      ...
      brand: obj['category'] || obj['brand'] || 'Revo',
      ...
      status: 'active',
      barcode: obj['barcode'] || obj['isbn'] || obj['upc'] || obj['gtin'] || '',
      supplier: obj['supplier'] || obj['vendor'] || ((obj['category'] || obj['brand'] || 'Revo').toLowerCase() === 'revo' ? 'Revo Slot' : ''),
      categories: obj['categories'] || '',
    }),
    brandKey: 'Revo',
    exportHeaders: ['Code', 'Description', 'Category', 'Unit', 'Retail Price - Inclusive', 'Last Cost', 'Qty On Hand', 'Sales Account', 'Purchases Account', 'Landed Cost', 'Cost', 'Pre Order Price'],
  ...
  brm: {
    ...
    mapRow: (obj) => ({
      ...
      title: obj['description'] || obj['title'] || obj['name'] || obj['desc'] || '',
      brand: obj['category'] || obj['brand'] || 'BRM',
      ...
      status: 'active',
      barcode: obj['barcode'] || obj['isbn'] || obj['upc'] || obj['gtin'] || '',
      supplier: obj['supplier'] || obj['vendor'] || ((obj['category'] || obj['brand'] || 'BRM').toLowerCase() === 'brm' ? 'BRM' : ''),
      categories: obj['categories'] || '',
    }),
    brandKey: 'BRM',
    exportHeaders: ['Code', 'Description', 'Category', 'Unit', 'Retail Price - Inclusive', 'Last Cost', 'Qty On Hand', 'Sales Account', 'Purchases Account', 'Landed Cost', 'Cost', 'Pre Order Price'],
  ...
  pioneer: {
    ...
    mapRow: (obj) => ({
      sku: obj['code'] || obj['sku'] || obj['item code'] || '',
      title: obj['description'] || obj['title'] || obj['name'] || obj['desc'] || '',
      brand: obj['category'] || obj['brand'] || 'Pioneer',
      ...
      status: 'active',
      barcode: obj['barcode'] || obj['isbn'] || obj['upc'] || obj['gtin'] || '',
      supplier: obj['supplier'] || obj['vendor'] || ((obj['category'] || obj['brand'] || 'Pioneer').toLowerCase() === 'pioneer' ? 'Pioneer' : ''),
      categories: obj['categories'] || '',
    }),
    brandKey: 'Pioneer',
    exportHeaders: ['Code', 'Description', 'Category', 'Unit', 'Retail Price - Inclusive', 'Last Cost', 'Qty On Hand', 'Sales Account', 'Purchases Account', 'Landed Cost', 'Cost', 'Pre Order Price'],
  ...
  sideways: {
    ...
    mapRow: (obj) => ({
      sku: obj['code'] || obj['sku'] || obj['item code'] || '',
      title: obj['description'] || obj['title'] || obj['name'] || obj['desc'] || '',
      brand: obj['category'] || obj['brand'] || 'Sideways',
      ...
      status: 'active',
      barcode: obj['barcode'] || obj['isbn'] || obj['upc'] || obj['gtin'] || '',
      supplier: obj['supplier'] || obj['vendor'] || ((obj['category'] || obj['brand'] || 'Sideways').toLowerCase() === 'sideways' ? 'Sideways' : ''),
      categories: obj['categories'] || '',
    }),
    brandKey: 'Sideways',
    exportHeaders: ['Code', 'Description', 'Category', 'Unit', 'Retail Price - Inclusive', 'Last Cost', 'Qty On Hand', 'Sales Account', 'Purchases Account', 'Landed Cost', 'Cost', 'Pre Order Price'],
                      ...
                      <tr className={`border-b hover:bg-gray-50 ${selectedIds.has(product.id) ? 'bg-blue-50' : ''}`}>
                        ...
                        <td className="py-2 px-2">
                          <div className="flex items-center gap-2">
                            <div className="w-28 h-28 bg-gray-100 rounded flex-shrink-0 flex items-center justify-center overflow-hidden">
                              {product.imageUrl
