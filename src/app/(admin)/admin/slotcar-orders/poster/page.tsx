...
export default function PreOrderPosterPage() {
  ...
  const handleExportToWhatsApp = () => {
    ...
    // Open synchronously — popup blockers only allow window.open inside a direct user gesture.
    // Any await before this call loses the gesture context and gets blocked.
