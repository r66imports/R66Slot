      ...
      if (posterRef.current) {
        ...
        if (blob) {
          ...
          if (navigator.share && navigator.canShare && navigator.canShare({ files: [file] })) {
            await navigator.share({ files: [file], title: `${orderType === 'pre-order' ? 'PRE-ORDER' : 'NEW ORDER'} – ${itemDescription}`, text: shareText })
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 gap-2 flex-wrap">
            ...
            <div className="flex items-center gap-2 flex-wrap justify-end">
              ...
              >
                {sendingWhatsapp ? <span className="animate-spin">⟳</span> : (
