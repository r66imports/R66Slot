...
interface BookingPageClientProps {
  code: string
  initialPoster: PosterData | null
}

export default function BookingPageClient({ code, initialPoster }: BookingPageClientProps) {
  const poster = initialPoster
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center font-play">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <p className="text-gray-600 mb-6 font-play">This booking link is invalid or no longer available.</p>
          <Link
            href="/"
